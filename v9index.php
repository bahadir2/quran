...
function updateLanguages() {
    ...
    function turkish2(x)
    {
        var turkish2 = document.getElementsByClassName("turkish2");
        if (x==false) {
            for (var i = 0; i < turkish2.length; i++) {
                turkish2[i].style.display = "none";
            }
        }else{
            for (var i = 0; i < turkish2.length; i++) {
                turkish2[i].style.display = "inline";
            }
        }
    }
    ...
    function swedish2(x)
    {
        var swedish2 = document.getElementsByClassName("swedish2");
        if (x==false) {
            for (var i = 0; i < swedish2.length; i++) {
                swedish2[i].style.display = "none";
            }
        }else{
            for (var i = 0; i < swedish.length; i++) {
                swedish2 [i].style.display = "inline";
            }
        }
    }
    function sas(x)
    ...
    function english2(x)
    {
        var english2 = document.getElementsByClassName("english2");
        if (x==false) {
            for (var i = 0; i < english2.length; i++) {
                english2[i].style.display = "none";
            }
        }else{
            for (var i = 0; i < english2.length; i++) {
                english2[i].style.display = "inline";
            }
        }
    }
    function eas(x)
    ...
    function subtextArabic(x)
    {
        var subtextArabic = document.getElementsByClassName("subtext-arabic");

        if (x==false) {
            for (var i = 0; i < subtextArabic.length; i++) {
                subtextArabic[i].style.display = "none";
            }
        }else{
            for (var i = 0; i < subtextArabic.length; i++) {
                subtextArabic[i].style.display = "inline";
            }
        }
    }
    ...
    function fasttr(x)
    {
        var blokTurkish = document.getElementsByClassName("blok-turkish");

        if (x==false) {
            for (var i = 0; i < blokTurkish.length; i++) {
                blokTurkish[i].style.display = "none";
            }
        }else{
            for (var i = 0; i < blokTurkish.length; i++) {
                blokTurkish[i].style.display = "inline";
            }
        }
    }
    ...
    function fastsv(x)
    {
        var blokSwedish = document.getElementsByClassName("blok-swedish");

        if (x==false) {
            for (var i = 0; i < blokSwedish.length; i++) {
                blokSwedish[i].style.display = "none";
            }
        }else{
            for (var i = 0; i < blokSwedish.length; i++) {
                blokSwedish[i].style.display = "inline";
            }
        }
    }
    ...
    function fasten(x)
    {
        var blokEnglish = document.getElementsByClassName("blok-english");

        if (x==false) {
            for (var i = 0; i < blokEnglish.length; i++) {
                blokEnglish[i].style.display = "none";
            }
        }else{
            for (var i = 0; i < blokEnglish.length; i++) {
                blokEnglish[i].style.display = "inline";
            }
        }
    }
    ...
    function fastor(x)
    {
            var blokArabic = document.getElementsByClassName("blok-arabic");

        if (x==false) {
            for (var i = 0; i < blokArabic.length; i++) {
                blokArabic[i].style.display = "none";
            }
        }else{
            for (var i = 0; i < blokArabic.length; i++) {
                blokArabic[i].style.display = "inline";
            }
        }
    }
    ...
    function normal2(x)
    {
        const baslikElements = document.getElementsByClassName("normal2");
    ...
    function secde2(x)
    {
        const baslikElements = document.getElementsByClassName("secde2");
...
switch (styleValue) {
    case 'subtitle':
        fasttr(false);fastor(false);
        turkish(false);tas(false);
        turkish2(turkishChecked);
        swedish2(swedishChecked);
        english2(englishChecked);
        swedish(false);sas(false);
        english(false);eas(false);
        normal2(true);secde2(true);
        normal(false);secde(false);
        arabic(false);
        subtextArabic(true);baslik(false);
        as(false);
document.getElementById("mesaj").innerText = 'cc';
        break;
    case 'standard':
        fasttr(false);fastor(false);
        ...
        arabic(true);baslik(true);
        subtextArabic(false);
        as(turkishChecked || swedishChecked || englishChecked);
        normal(true);secde(true);
        normal2(false);secde2(false);
        document.getElementById("mesaj").innerText = 'dd';
        break;
    case 'fast':
        fastor(true);
