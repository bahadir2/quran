...
<label for="libSelect">Library:</label>
...
<form id="logoutForm" action="logout.php" method="GET" style="display: inline;">
    ...
    <button type="submit" class="button-link" style="border:none; background:none; cursor:pointer;">
        &#x23FB;  <!-- Power/Logout simgesi --></button>
</form>
