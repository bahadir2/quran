...
<!-- Ayar Paneli -->
  ...
  <a onclick="toggleSettings()" title="Ayarlar" class="action-button">&#9881;</a> 
      <button onclick="window.location.href='login.php'" class="action-button logout-button" title="Giriş" disabled>Login</button>
...
<div class="settings-bar" id="settingsBar">
  <div class="language-options">
    <label><input type="checkbox" id="turkish" onclick="updateLanguages()"> <br>Türkçe <br><font color=red size='2'>Suat Yıldırım</font></label>
    <span class="divider"></span>
    <label><input type="checkbox" id="swedish" onclick="updateLanguages()"> <br>Svenska <br><font color=red size='2'>Knut Bernström</font></label>
    <span class="divider"></span>
    <label><input type="checkbox" id="english" onclick="updateLanguages()"> <br>English <br><font color=red size='2'>Abdullah Yusuf Ali</font></label>
